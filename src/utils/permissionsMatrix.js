export const PERMISSIONS_MATRIX = [
	...
	{ method: 'GET', path: '/api/alertas/whatsapp/pendientes', roles: ['ADMIN', 'SUPERVISOR'] },
	{ method: 'PATCH', path: '/api/alertas/whatsapp/:destinatarioId/enviado', roles: ['ADMIN', 'SUPERVISOR'] },
